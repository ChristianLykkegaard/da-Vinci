...
\chapter{Introduction}\label{chap:intro}
	\input{problemanalysis/Introduction}
...
\chapter{Interim Conclusion} \label{chap:interim_con}
		...
		\input{problemanalysis/interim.tex}
\chapter{Requirement Specification}\label{chap:reqspec}
		\input{requirementspec/kravspec.tex}
...
\chapter{Conclusion}\label{chap:conclusion}
		\input{ending/conclusion.tex}
\chapter{Perspective}\label{chap:perspektivering}	
		\input{ending/perspective.tex}
