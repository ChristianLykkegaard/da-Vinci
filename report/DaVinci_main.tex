...
\part[Safe Controller Design from Control Barrier Functions]{Safe Controller Design from \\Control Barrier Functions}\chaptermark{Safe Controller Design from Control Barrier Functions}
\chapter{Controller Design from CBFs}\label{chap:cbf}
	\input{safe_robotic_surgery}


\part[Controller Safety Verification with Putinar's Positivstellensatz]{Controller Safety Verification with \\Putinar's Positivstellensatz}  % Title in square brackets is what goes in TOC
...
\chapter{Putinar's Positivstellensatz}\label{chap:putinar}
	\input{putinar.tex}
\chapter{Safety of 1st Order System in 1D}
	\input{sos_1stordersys_1d}
