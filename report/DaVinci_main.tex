...
\chapter{Safety\,Verification\,with\,Barrier\,Certificates}\chaptermark{Safety Verification with Barrier Certificates}\label{chap:putinar}
	\input{putinar.tex}
\chapter{Barrier Certificate Search}\label{chap:sostools}
	\input{sostools}
