...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{20150526_103311.jpg}
	\caption{Prostatectomy at Aalborg University Hospital conducted by surgeon Grazvydas Tuckus with the da Vinci Xi robot. In the foreground robot assistant nurse Jane Petersson is seen.}
	\label{fig:surgery}
\end{figure}
