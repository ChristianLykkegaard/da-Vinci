...
\item Path planning
\end{itemize}
A crucial matter when dealing with those topics within robotic surgeries feature necessary conditions to guarantee the patient safety to avert patient trauma \citep{bib:safety}.
\section{Safety Precautions for Automated Control}
