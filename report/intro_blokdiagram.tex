...
This report presents the work on a guaranteed safe end-effector trajectory control, %. As opposed to the safety control by virtual potential field constraints \citep{bib:dlr_miro}, this work utilizes 
...
The above pool of stipulations essentially and practically entails the following main topics of this thesis:
\begin{itemize}
\itemsep-1.3mm
	...
	\item Dynamic setpoint (position) tracking relative to a point on the surface of a beating heart.
\end{itemize}
