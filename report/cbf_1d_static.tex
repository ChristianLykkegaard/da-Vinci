...
\end{flalign*}
\Autoref{eq:2order} can be transferred to state space form: {\color{green}{RAFAL: Giver den mening ifm barriere funktioner!!!!????? Vi bliver n\o dt til at diskutere det lidt. Vi er is\ae r i tvivl om hvad nul er og hvad det betyder at nul er en position, hvorimod (?) nul i barriere certifikater virker som v\ae rende noget vi ikke kan kontrollere..}}
\begin{subequations}
\begin{flalign}
...
\begin{figure}[H]
	\center
		\includegraphics[scale=0.6]{control_signal_2.eps}
