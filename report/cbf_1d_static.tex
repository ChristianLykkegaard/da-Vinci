...
\begin{flalign*}
 \left.
 \begin{aligned}
a\,\Lambda_{\text{lim}+}^2 + b\,\Lambda_{\text{lim}+} + c = 0 \\
a\,\Lambda_{\text{lim}-}^2 + b\,\Lambda_{\text{lim}-} + c = 0 \\
a\left( \frac{\Lambda_{\text{lim}-}+\Lambda_{\text{lim}+}}{2}\right)^2 + b\left(\frac{\Lambda_{\text{lim}-}+\Lambda_{\text{lim}+}}{2}\right) + c = \underbrace{-0.025}_\text{any constant $<0$} 
\end{aligned}
\mm \right\}
 \qquad \begin{matrix}
...
\begin{flalign*}
B(x_1,x_2) =  \left( \dfrac{(x_1-x_{10})^2}{a^2} + \dfrac{(x_2-x_{20})^2}{b^2} \right) c_1 + c_2
\end{flalign*}
...
\subsection{Construction of $K$ and $\bar{N}$ based on 1nd Order Model}\label{sec:K_Nbar_1D_1storder}
