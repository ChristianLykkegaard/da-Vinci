\section{Safety Verification of First Order System with Zero Reference}\label{app:sos_noref}
...
\section{Safety Verification of Second Order Error State System}\label{app:sos_errorstate_secondorder}
