...
\lstdefinelanguage{matlab} {              % Definition af Arduino-language
	morekeywords={all, on, quiet, x(n,N), u(p,N),to, pvar},
...
\lstdefinelanguage{cmake} {              % Definition af Arduino-language
	morekeywords={export,run_depend,build_depend,buildtool_depend,author,cmake_minimum_required,name,maintainer,version,license,find_package,package,include_directories,add_executable,target_link_librarie},
