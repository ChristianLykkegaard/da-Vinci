...
\renewcommand{\nompreamble}{
The Symbol- and Acronym List expands first all used acronyms in the report followed by an elaboration of all used symbols. Finally, it features some additional remarks for the used nomenclature.
